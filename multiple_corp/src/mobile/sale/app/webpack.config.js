...
//移动端【高清】方案
baseConfig.postcss = [];
baseConfig.postcss.push(pxtorem({
    rootValue: 100,
    propWhiteList: [],
}));
...
if (__DEV__) {
    ...
    baseConfig.output.publicPath = "//1.staticec.com/mobile/sale/app/";
    baseConfig.output.path = path.join(__dirname, '../../../../resources/static/mobile/sale/app');
    baseConfig.plugins.push(
        new HtmlWebpackPlugin({
            template: path.resolve(__dirname, "client", "index.html"),
            hash: false,
