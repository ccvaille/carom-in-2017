...
import * as funnelAllActions from '../../actions/funnelAllActions'
...
class FunnelAll extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount() {
        ...
        let { funnelAllActions, funnelAllReducers } = this.props;
        funnelAllActions.getAuth();
        funnelAllActions.fetchFunnelData();
        funnelAllActions.getTip();
    }
    componentWillUnmount() {
        document.removeEventListener('touchmove',touchMoveHandler);
        document.removeEventListener('touchend',touchEndHandler)
        let { funnelAllActions, funnelAllReducers } = this.props;
        funnelAllActions.initState();
    }
    ...
    handleFilterChange = (value) => {
        let { funnelAllActions, funnelAllReducers } = this.props;
        let { tabIndex,dept } = funnelAllReducers;
        funnelAllActions.filterChange({
            dept: value.dept
        });
        if ((typeof value.dept.id !== 'undefined') && value.dept.id !== dept.id) {
            browserHistory.push({
    ...
    closeGuideModal= () => {
        let {funnelAllActions} = this.props;
        funnelAllActions.setTip();
    }
    ...
    toggleView = (value) => {
        const { funnelAllActions, funnelAllReducers } = this.props;
        let { dept, tabIndex, month, year, ...others } = funnelAllReducers;
        funnelAllActions.switchTab(value);
    ...
    render = () => {
        let { auth,data, dept, tabIndex,showGuideModal,fetching,...others } = this.props.funnelAllReducers;
        ...
        console.warn(this.state.stateModalVisible);
...
const mapStateToProps = ({ funnelAllReducers }) => ({
    funnelAllReducers,
});

const mapDispatchToProps = dispatch => ({
    funnelAllActions: bindActionCreators(funnelAllActions, dispatch)
});

export default connect(mapStateToProps, mapDispatchToProps)(FunnelAll);
