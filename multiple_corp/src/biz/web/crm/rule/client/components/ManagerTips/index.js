...
import './index.less';
import cookiesHelper from '../../util/cookiesHelper'
...
class ManagerTips extends React.Component {
    ...
    componentWillMount(){
        var ecbiz = this.props.ecbiz;
        //如果管理其他企业的账户
        if(ecbiz && ecbiz.corphook){
    ...
    handleClose(){
        ...
        let corpIds=JSON.parse(cookiesHelper.getItem('corpIds'))||[];
        let corpName=this.props.ecbiz.corphookinfo.cname;
    ...
    render() {
        ...
        return (
            ...
            <div className="top-tip"><p>您正在对“{ this.props.ecbiz.corphookinfo.cname }”的企业后台进行相关管理，请谨慎操作，避免影响到他人的使用。<span className="close-btn" onClick={this.handleClose.bind(this)}><i className="iconfont">&#xe611;</i></span></p></div>
            </div> : null
        )
    }
}
