...
function keywordStats(state = initialState, action) {
    switch (action.type) {
        case KeywordStatsActionTypes.GET_KEYWORD_STATS_SUCCESS: {
        ...
        case KeywordStatsActionTypes.UPDATE_KEYWORD_STATS_PARAMS: {
            const data = action.payload;
            const newState = {
                ...state,
                params: {
