...
function success(content, duration,onclose=null) {
    message.success(content, duration);
    renderMask(duration);
}

function error(content, duration,onclose=null) {
    message.error(content, duration);
    renderMask(duration);
}

function info(content, duration,onclose=null) {
    message.info(content, duration);
    renderMask(duration);
}

function warning(content, duration,onclose=null) {
    message.warning(content, duration);
    renderMask(duration);
}
function warn(content, duration,onclose=null) {
