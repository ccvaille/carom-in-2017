...
baseConfig.entry.myPublic = __DEV__
    ? [
...
if (__DEV__) {
    ...
    baseConfig.output.publicPath = "//1.staticec.com/my/public/";
    baseConfig.output.path = path.join(__dirname, '../../../resources/static/my/public');
    baseConfig.plugins.push(
        new HtmlWebpackPlugin({
            template: path.resolve(__dirname, "client", "index.html"),
            hash: false,
